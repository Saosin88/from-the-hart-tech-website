      ...
      <UCard class="p-6">
        <div class="flex flex-col sm:flex-row gap-4">
          <div class="flex flex-col items-center sm:w-1/4">
            <UIcon name="i-lucide-gamepad-2" class="text-5xl text-primary-600 dark:text-primary-400 mb-2" />
            <div class="text-center font-medium">Gaming</div>
          </div>
          <div class="flex flex-col items-center sm:w-1/4">
            <UIcon name="i-lucide-book-open" class="text-5xl text-primary-600 dark:text-primary-400 mb-2" />
            <div class="text-center font-medium">Reading</div>
          </div>
          <div class="flex flex-col items-center sm:w-1/4">
            <UIcon name="i-lucide-film" class="text-5xl text-primary-600 dark:text-primary-400 mb-2" />
            <div class="text-center font-medium">Movies & TV</div>
          </div>
          <div class="flex flex-col items-center sm:w-1/4">
            <UIcon name="i-lucide-heart" class="text-5xl text-primary-600 dark:text-primary-400 mb-2" />
            <div class="text-center font-medium">Family</div>
          </div>
        </div>
...
<script setup lang="ts">
  useSeoMeta({
    title: 'About Me - Sheldon Hart',
    description: 'Learn about Sheldon Hart, a solutions architect with expertise in Java, AWS, and enterprise architecture.',
    keywords: 'Sheldon Hart, solutions architect, software development, Java, AWS, enterprise architecture',
    robots: 'index, follow',
    author: 'Sheldon Hart',
    ogTitle: 'About Sheldon Hart - Solutions Architect',
    ogDescription: 'Learn about my journey, skills, and experience as a solutions architect and software developer.',
    ogImage: 'https://www.fromthehart.tech/logo/from-the-hart.png',
    ogUrl: 'https://www.fromthehart.tech/about',
    twitterTitle: 'About Sheldon Hart - Solutions Architect',
    twitterDescription: 'Learn about my journey, skills, and experience as a solutions architect and software developer.',
