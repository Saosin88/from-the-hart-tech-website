<template>
  <section class="flex flex-col items-center justify-center min-h-[50vh] px-6 py-12 text-center">
    ...
    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
      <UButton @click="handleError" class="flex items-center justify-center px-6 py-2">
        <UIcon name="lucide:home" class="mr-2 h-5 w-5" />
        Return Home
      </UButton>

      <UButton @click="$router.back()" color="neutral" class="flex items-center justify-center px-6 py-2">
...
<script setup>
  defineProps({ error: Object, require: false })
